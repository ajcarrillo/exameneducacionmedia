                ...
                <tr>
                    <td align="center" valign="top" id="bodyCell">
                        ...
                        <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
                            <tr>
                                <td align="center" valign="top">
                                    <img src="http://exameneducacionmedia.test/img/secretaria-seq.png"></img>
                                </td>
                            </tr>
                                                                ...
                                                                <tr>
                                                                    <td align="center" valign="top" class="textContent">
                                                                        <h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">
                                                                            Sistema de Ingreso a la Educación Media</h1>
                                                                        ...
                                                                        <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
                                                                            Usted está recibiendo este correo electrónico porque ha solicitado un restablecimiento de contraseña
                                                                            para la cuenta de
                                                                            usuario en SIEM.
                                                                        </div>
                                                                        <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
                                        ...
                                        <tr style="padding-top:0;">
                                            <td align="center" valign="top">
                                                ...
                                                <table border="0" cellpadding="30" cellspacing="0" width="500" class="flexibleContainer">
                                                    ...
                                                    <!--<tr>
														<td style="padding-top:0;" align="center" valign="top" width="500" class="flexibleContainerCell">
															<p>Si no puedes hacer click en el botón de arriba, copia y pega la siguiente dirección en la barra de direcciones de tu navegador</p>
															<p></p>
														</td>
													</tr>-->
                                                </table>
							...
							-->
                            <tr mc:hideable>
                                <td align="center" valign="top" style="background: #28afcd;">
                                    <!-- CENTERING TABLE // -->
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td align="center" valign="top">
                                                                            ...
                                                                            <tr>
                                                                                <td align="left" class="textContent">
                                                                                    <img style="width: 190px; height: 90px"
                                                                                         src="http://www.seyc.gob.mx/images/mas_y_mejores_oportunidades_quintana_roo.jpg">
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                        ...
                                                                        <table class="flexibleContainerBoxNext" border="0" cellpadding="0" cellspacing="0" width="210" style="max-width: 100%;">
                                                                            <tr>
                                                                                <td align="left" class="textContent">
                                                                                    ...
                                                                                    <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:12px;margin-bottom:0;color:#FFF;line-height:135%;">
                                                                                        Gobierno del Estado de Quintana Roo
                                                                                        Secretaría de Educación y Cultura
                                                                                        Av. Insurgentes No. 600 - Col. Gonzalo Guerrero
                                                                                        Teléfono : 01 (983) 83 - 507 - 70
