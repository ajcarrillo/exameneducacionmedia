        ...
        <div style="padding: 0.5cm" class="page">
            <div class="dtll">
                ...
                <div id="gral" style="text-align:center">
                    ...
                    <h6><b>PASE AL EXAMEN</b><br>PARA ALUMNOS DE TERCERO DE SECUNDARIA</h6>
                    <div id="foto"><p>FOTO</p></div>
                </div>
                ...
                <div style="text-align:center">
                    ...
                    <div class="text-justify" style="font-size: 12px;padding: 10px;">
                        <p style="font-size: 9px; line-height:1">
                            <i>
                                <strong>Nota: </strong>Los espacios se asignarán tomando en cuenta los aciertos obtenidos en el examen de admisión, y al orden seleccionado de acuerdo a la preferencia de plantel, habiéndose verificado la capacidad de espacios de cada uno de los planteles públicos.
                                <i style="color:darkgrey;">En caso de empate se tomará en cuenta los dictámenes de las áreas del examen diagnóstico.</i>
                            </i>
                        </p>


                        <p style="margin-top: 10px">A continuación, aparecen los nombre de la localidad y municipio donde se encuentra la escuela del nivel medio de tu primera preferencia, según escogiste tus opciones educativas.</p>
                    </div>
                    ...
                    <div class="text-justify" style="font-size: 12px;padding: 10px;">
                        Al suscribirse esta solicitud se hace constar que los datos anotados son verdaderos y que se aceptan las condiciones y procedimientos que aparecen en la Convocatoria. La asignación del turno será atribución de las instituciones educativas correspondientes.
                    </div>

                    <div style="margin-top: 10px;  border-bottom-color: lightgrey; border-bottom-style: dashed; border-bottom-width: 1px">
                        <table style="margin-bottom: 10px;" >
                            <tr>
                                <td width="266px"><hr style="width: 80%"></td>
                                <td width="266px"><hr style="width: 80%"></td>
                                <td width="266px"><hr style="width: 80%"></td>
                            </tr>
                    ...
                    <div class="text-justify">
                        <p style="font-size: 9px; line-height:1" class="mt-2">
                            ...
                            Después del pago efectuado, de 1 a 3 días, ingresa al portal de registro, para poder imprimir "Pase al Examen". Recuerda que después de la fecha límite de la referencia bancaria, no podrás realizar el pago. Presentarse 30 minutos, antes del inicio de examen, llevar lápiz del número 2 1/2, goma y sacapuntas.
                            </i>
                        </p>
                    </div>
