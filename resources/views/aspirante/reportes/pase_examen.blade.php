            ...
            <div class="dtll">
                <div >
                    ...
                    <div style="float: right; text-align: center; width: 400px; background-color: lightgrey; padding: 9px; font-size: 13px ">
                        http://paenms.seq.gob.mx o http://siem.seq.gob.mx
                    </div>
                ...
                <div style="text-align:center">
                    ...
                    <div class="row" style="margin: auto; width: 100%;">
                        ...
                        <div class="col-tit" style=" width: 60%;">CLAVE ÚNICA DE RIGISTRO DE POBLACION</div>
                    ...
                    <div style="margin-top: 20px;  border-bottom-color: lightgrey; border-bottom-style: dashed; border-bottom-width: 1px">
                    ...
                    <div>
                        <table style="font-size: 11px; ">
                            <tr style="font-weight: bold">
                                <td rowspan="2" >Pase al examen</td>
                                <td width="100px">Folio Ceneval</td>
                                <td width="250px">Fecha y hora</td>
                                <td width="200px">Sede</td>
                                <td width="50px">Aula</td>
