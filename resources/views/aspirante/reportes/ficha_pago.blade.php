    ...
    <div style="padding: 0.5cm" class="page">
        <div class="dtll">
            ...
            <div style="text-align:center">
                ...
                <div class="row" style="margin: auto; width: 100%;">
                    <div class="col-tit" style=" width: 49%;">REGISTRO FEDERAL DE CONTRIBULLENTES</div>
                    <div class="col-tit" style=" width: 49%;">CLAVE UNICA DE REGISTRO DE POBLACION</div>
                </div>
                <div class="row" style="margin: auto; width: 100%;">
                ...
                <div class="row" style="margin: auto; width: 100%;">
                    <div class="col-tit" style=" width: 70%;">NUMERO</div>
                    <div class="col-tit" style=" width: 28%;">CODIGO POSTAL</div>
                </div>
                <div class="row" style="margin: auto; width: 100%;">
            ...
            <table class=" tabledetll">
                ...
                <tr>
                    ...
                    <th style="width: 200px">NUM.SALARIOS MINIMOS</th>
