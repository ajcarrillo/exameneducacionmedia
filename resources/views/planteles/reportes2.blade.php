		...
		<div class="contenedor">
			@foreach($aulas as $aula)
				<div class="page">
					...
					<div class="footer">
						<div class="firma">Nombre y firma del docente aplicador</div>
						<br>
						{{'*** Aspirantes con derecho a presentar examen que no concluyeron su registro en línea en el plazo especificado.'}}
						<br>{{Jenssegers\Date\Date::parse(\Carbon\Carbon::now())->format('j \\d\\e F Y')}}
						<br>
						<div style="margin-left: 940px">Aula:{{$aula->id}}</div>
					</div>
				</div>
			@endforeach
		</div>
