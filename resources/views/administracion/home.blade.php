...
@section('content')
	<div class="content">
		<div class="row">
			<div class="col-md-3">
				@if($activar == 1)
					<a class="btn" disabled="true" style="background:#00a65a;color: white;" href="{{route('media.administracion.panelAdministracion.cancelarOferta')}}" id="btn_desactivar">Desactivar
						Ofertas</a>
				@endif
			</div>
			<div class="col-md-3">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<p>
					...
					<a class="btn btn-lg btn-block" style="background:#00a65a;color: white;font-size: 13pt" data-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
						<span class="small-box-footer"><i class="fa fa-info-circle"></i></span>
						Impresión
						de Reportes</a>
				</p>
