			...
			<div style="padding: 0.5cm">
				<div class="dtll">
					...
					<div style="text-align:center">
						...
						<h5>
							Reporte primera opción (Modalidad secundaria)
						</h5>
							...
							<tbody>
								@foreach($aspirantes as $aspirante)
									<tr>
										...
										<td>{{ ($aspirante->revision_efectuada == 1)?'SI':'NO'}}</td>
										<td>{{ ($aspirante->pase_examen)?'SI':'NO'}}</td>
									</tr>
								@endforeach
							</tbody>
						</table>
