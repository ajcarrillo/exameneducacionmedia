...
<div class="form-group">
    ...
    {!! Form::date('fecha_inicio', NULL, ['class'=>'form-control '.($errors->has('fecha_inicio') ? ' is-invalid' : ''), 'required']) !!}
    @errors(['errors'=>$errors, 'field'=>'fecha_inicio'])
    @enderrors
</div>
<div class="form-group">
    {!! Form::label('fecha_fin', 'Fecha fin', ['class'=>'control-label']) !!}
    {!! Form::date('fecha_fin', NULL, ['class'=>'form-control '.($errors->has('fecha_fin') ? ' is-invalid' : ''), 'required']) !!}
