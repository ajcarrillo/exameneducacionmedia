...
<body>
    ...
    @foreach($datos->groupBy('subsistema') as $groupData)

        <div class="page_tbll">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h5 style=" padding-left: 6em; font-weight: bold">{{$groupData[0]['subsistema']}}</h5>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-10">

                @foreach($groupData->groupBy('municipio') as $dato)
