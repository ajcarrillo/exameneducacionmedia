            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
	                    ...
	                    {!! Form::open(['class'=>'', 'method'=>'post', 'route'=>['media.administracion.estudiante.buscar'], 'name'=>'form-buscar', 'id' => 'form-buscar']) !!}
		                    <div class="form-row">
                    ...
                    <div class="card-body">
	                    <div class="progress" id="barLoading" style="display: none;">
		                    <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 75%">Buscando...</div>
	                    </div>
	                    @if($buscar)
		                    <div id="tableEstudiantes" style="display: block;">
			                    <p class="text-right">
